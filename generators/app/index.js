...
const jhipsterVar = { moduleName: 'groovy' };
...
module.exports = EntityGenerator.extend({
    ...
    initializing: {
        ...
        displayLogo() {
            ...
            this.log(`Welcome to the ${chalk.bold.yellow('JHipster groovy')} generator! ${chalk.yellow(`v${packagejs.version}\n`)}`);
        },
        ...
        getConfig() {
            ...
            this.searchEngine = jhipsterVar.searchEngine === 'no' ? false : jhipsterVar.searchEngine;
            this.messageBroker = jhipsterVar.messageBroker === 'no' ? false : jhipsterVar.messageBroker;
    ...
    writing: writeFiles(),
        ...
        this.log('End of groovy generator');
    }
});
